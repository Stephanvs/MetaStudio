namespace TestClient
{
	partial class RenameModelForm
	{
		...
		private void InitializeComponent()
		{
			...
			// tbNewModelName
			// 
			this.tbNewModelName.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.tbNewModelName.Location = new System.Drawing.Point(12, 35);
			this.tbNewModelName.Name = "tbNewModelName";
			this.tbNewModelName.Size = new System.Drawing.Size(401, 20);
			this.tbNewModelName.TabIndex = 1;
			// 
			// label1
			// 
			...
			this.label1.Text = "Type the new name for the model";
			// 
			// button2
			// 
			...
			this.Name = "RenameModelForm";
			this.Text = "Rename Model";
